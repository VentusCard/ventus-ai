...
//
// It reuses the EXISTING shared normalizer (shared/plaid-transactions-sync.mjs)
...
import { normalizePlaidTransactionsSync } from '../shared/plaid-transactions-sync.mjs';
