    ...
    <div className="px-4 py-3 border-b border-slate-200 bg-white flex flex-col lg:flex-row lg:items-center gap-3">
      <div className="relative w-full lg:max-w-sm">
        ...
        <input
          ...
          placeholder="Search example customers by name, city, product, or signal"
          className="w-full pl-9 pr-8 py-2 text-[12.5px] border border-slate-200 rounded-lg bg-slate-50/60 text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400/40 focus:border-blue-300 focus:bg-white transition"
        />
        {query && (
          <button
            onClick={() => setQuery("")}
