...
import { Calendar as CalendarIcon, ChevronDown, RefreshCw, GitCompareArrows } from "lucide-react";
    ...
    <div className="flex items-center justify-between flex-wrap gap-2">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <Popover open={compareOpen} onOpenChange={setCompareOpen}>
          ...
          <PopoverContent align="start" className="w-[200px] p-1 bg-white border-slate-200">
