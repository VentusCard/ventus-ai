...
const OutcomesSection = () => {
  return (
    <section id="outcomes" className="scroll-mt-24 bg-white py-24 md:py-28">
      <div className="mx-auto mb-12 md:mb-14 max-w-7xl px-6 md:px-8">
        <ScrollReveal>
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          {columns.map((c, i) => (
            <div
              key={c.label}
              className={`relative min-w-0 px-5 py-14 lg:px-6 ${
                i > 0 ? "border-t border-gray-200 sm:border-l sm:border-t-0 lg:border-l lg:border-t-0" : ""
              }`}
            >
              <span
