...
const personas = [
  {
    ...
    playName: "Travel card upgrade play",
    lift: "+18% incremental upgrades",
    holdout: "10% holdout",
  },
  {
    id: "parent" as const,
    ...
    playName: "529 outreach play",
    lift: "+32% incremental 529 openings",
    holdout: "10% holdout",
  },
  {
    id: "college" as const,
    ...
    playName: "College savings play",
    lift: "+24% incremental consultations",
    holdout: "10% holdout",
  },
];

const STAGE_LABELS = ["Raw Stream", "Categorize", "Detect", "Growth Play"];
      ...
      <div className="sticky top-0 xl:h-screen min-h-screen flex items-start justify-center overflow-visible pt-24 md:pt-28 xl:pt-16 pb-10">
        <div className="w-full max-w-7xl mx-auto px-6 flex flex-col xl:flex-row items-center xl:items-center gap-6 xl:gap-6">
          ...
          <div className="contents xl:flex xl:flex-col xl:w-[62%] xl:items-start w-full">
            ...
            <div
              className="order-4 xl:order-none mt-6 xl:mt-7 flex flex-wrap items-center gap-3 transition-all duration-700 ease-out"
              style={{
                opacity: loaded ? 1 : 0,
                transform: loaded ? "translateY(0)" : "translateY(20px)",
          ...
          <div className="order-2 xl:order-none w-full xl:w-[38%] flex justify-center xl:justify-end mt-2 xl:mt-0">
            <div className="relative flex flex-col items-stretch" style={{ width: 400, maxWidth: "calc(100vw - 48px)" }}>
              ...
              >
                ...
                {/* Measured outcome readout */}
                {activePersona && (
                  <div
                    className="relative z-10 mt-3 flex items-center justify-between gap-2 rounded-md px-3 py-2"
                    style={{
                      background: "rgba(255,255,255,0.85)",
                      border: "1px solid #E5E7EB",
                      boxShadow: "0 1px 3px rgba(0,0,0,0.05)",
                      opacity: personaWindowProgress > 0.3 ? 1 : 0,
                      transform: personaWindowProgress > 0.3 ? "translateY(0)" : "translateY(6px)",
                  ...
                  >
                    ...
                    <span className="shrink-0 flex flex-col items-end gap-1">
                      ...
                      >
                        {activePersona.holdout}
                      </span>
                      {/* Honesty chip: no invented number passes as a customer result. */}
                      <span className="text-[8px] font-bold uppercase tracking-[0.1em] px-1.5 py-0.5 rounded-full border border-amber-200 bg-amber-50 text-amber-800">
                        Illustrative play
                      </span>
                    </span>
                  </div>
                    ...
                    <div className="px-3 pb-2.5 pt-0.5 border-t border-gray-100">
                      ...
                      {activePersona && (
                        <div className="mt-1.5 flex items-center justify-between gap-2">
                          <span className="text-[11px] font-bold" style={{ color: activePersona.color }}>
                            {activePersona.lift}
                          </span>
                          <span className="flex items-center gap-1">
                            <span className="text-[8px] font-semibold px-1.5 py-0.5 rounded-full bg-gray-100 text-gray-600">
                              {activePersona.holdout}
                            </span>
                            <span className="text-[7px] font-bold uppercase tracking-[0.08em] px-1.5 py-0.5 rounded-full border border-amber-200 bg-amber-50 text-amber-800">
                              Illustrative
                            </span>
                          </span>
                        </div>
