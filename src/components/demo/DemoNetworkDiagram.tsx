...
const PILLAR_ROWS: PillarRow[] = [
  ...
  },
  {
    ...
    color: "#f97316",
    bankNodes: [
      { id: "lifeEventIntel", label: "Life Event Detection", icon: CalendarHeart, color: "#f97316", audience: "bank" },
      { id: "lifeEvents", label: "Next-Product Automation", icon: TrendingUp, color: "#f97316", audience: "bank" },
      { id: "wmCopilot", label: "Advisor CoPilot Suite", icon: Briefcase, color: "#f97316", audience: "bank" },
    ],
    consumerNode: { id: "wealth", label: "Personalized Relationship", icon: TrendingUp, color: "#f97316", audience: "consumer" },
  },
];
...
const IMPACT_METRICS: { metrics: string[]; color: string }[] = [
  ...
  { metrics: ["Higher Cross-Sell", "Higher AUM Growth", "Higher Lifetime Value", "Higher Advisor Effectiveness"], color: "#f97316" },
];
