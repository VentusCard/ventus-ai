    ...
    <div className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/50">
      <div className="flex h-14 md:h-16 items-center justify-between px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex items-center flex-1 md:flex-initial">
          <Link to="/tepilot" onClick={closeMobileMenu} className="group">
            <span className="text-xl font-bold tracking-wide text-foreground">VENTUS</span>
          </Link>
        </div>
        ...
        <div className="hidden md:flex items-center space-x-8">
          <Link 
            to="/tepilot"
            className="text-foreground/90 hover:text-foreground font-medium text-sm transition-all duration-300 px-3 group"
          >
            <span className="relative">
              TePilot
              <span className="absolute -bottom-1 left-1/2 w-0 h-0.5 bg-foreground transition-all duration-300 group-hover:w-full group-hover:left-0"></span>
            </span>
          </Link>
          <Link 
            to="/contact"
      ...
      <div className={`md:hidden absolute top-full left-0 right-0 bg-background/98 backdrop-blur-lg border-b border-border/50 transition-all duration-300 ease-in-out ${
        ...
        <div className="px-4 py-6 space-y-4">
          <Link 
            ...
            className="block text-foreground/90 hover:text-foreground font-medium text-lg py-3 px-2 transition-all duration-300 border-b border-border/10 hover:bg-foreground/5 rounded"
          >
            TePilot
          </Link>
          <Link 
