...
const Hero = () => {
  return (
    <div className="relative bg-white text-gray-900 flex items-start lg:items-center justify-center overflow-hidden pt-36 pb-24 md:py-32 lg:min-h-screen lg:py-0">
