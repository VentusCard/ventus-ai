  ...
  return (
    <section className="py-24" style={{ background: "#0a0f1e" }}>
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        ...
        {/* Stats */}
        <div ref={statsRef} className="mt-20 grid grid-cols-2 md:grid-cols-3 gap-8 text-center">
          <div>
            <p className="text-4xl md:text-5xl font-bold text-white">{statsVisible ? count0 : 0}{stats[0].suffix}</p>
            <p className="text-gray-400 mt-1">{stats[0].label}</p>
          </div>
          <div>
            <p className="text-4xl md:text-5xl font-bold text-white">{statsVisible ? count1 : 0}</p>
            <p className="text-gray-400 mt-1">{stats[1].label}</p>
          </div>
          <div>
            <p className="text-4xl md:text-5xl font-bold text-white">Real-time</p>
            <p className="text-gray-400 mt-1">{stats[2].label}</p>
          </div>
        </div>
      </div>
    </section>
