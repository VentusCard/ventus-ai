...
const CampaignStudioPreview = () => {
  ...
  return (
    ...
    >
      ...
      <div
        key={active.id}
        className="rounded-2xl border border-gray-200 bg-white p-7 animate-in fade-in slide-in-from-bottom-2 duration-300"
      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 mb-5 pb-5 border-b border-gray-100">
          ...
          <span className="px-3 py-1 rounded-full bg-green-50 text-green-700 text-[12px] font-medium border border-green-100 shrink-0">
            {formatReach(active.reach)} reachable
          </span>
        </div>

        {/* Subject */}
        <p className="text-[15px] font-semibold text-gray-900 mb-3 leading-snug">
          {active.subjectLead}
          <MergeToken />
          {active.subjectTrail}
        </p>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="px-2.5 py-1.5 rounded-md bg-blue-600 text-white text-[12px] font-semibold leading-none">
            3% · {active.topCategory}
          </span>
          <span className="px-2.5 py-1.5 rounded-md bg-blue-100 text-blue-700 text-[12px] font-semibold leading-none">
            2% · {active.secondCategory}
          </span>
          <span className="px-2.5 py-1.5 rounded-md bg-gray-100 text-gray-600 text-[12px] font-medium leading-none">
            1% · everything else
          </span>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 mb-5">
          <span className="px-2.5 py-1.5 rounded-md bg-emerald-50 border border-emerald-100 text-emerald-700 text-[12px] leading-none">
            {active.valueMath}
          </span>
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md bg-white border border-gray-200 text-gray-600 text-[12px] leading-none">
            Personalized est.
        ...
        <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-2">
            {["Email", "Mobile Push", "In-App"].map((c) => (
              <span
                key={c}
                className="px-2 py-1 rounded bg-gray-100 text-gray-600 text-[11px] font-medium"
              >
                {c}
              </span>
            ))}
        ...
        {/* Progress bar */}
        <div className="mt-5 -mx-7 -mb-7 h-1.5 w-[calc(100%+56px)] bg-gray-100 rounded-b-2xl overflow-hidden">
          <div
