      ...
      <table className="w-full text-left border-collapse min-w-[1480px]">
        <thead className="sticky top-0 z-10">
          ...
          <tr className="bg-slate-50/80 border-b border-slate-200">
            ...
            <th className={`text-slate-600 text-[13px] font-semibold uppercase tracking-wider pl-5 pr-2 py-2 whitespace-nowrap ${COL.tier}`}>Tier</th>
          ...
          {(() => {
            ...
            return (
              ...
              >
                ...
                <td key={`enr-tier-${idx}-${isEnriched ? revealKey : "pending"}`} className={`exec-enriched-cell pl-5 pr-2.5 py-2 ${COL.tier}`}>
                  {isEnriched ? (
