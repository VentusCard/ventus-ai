...
export default function NextConversationRationale({
  ...
  return (
    <div className="h-full min-h-0 grid grid-cols-2 gap-2 animate-in fade-in duration-300" key={effectiveSignal.label}>
      {/* ============ LEFT: REGULAR CLIENT ============ */}
      <div className="flex flex-col min-h-0 rounded-xl border border-slate-200 bg-white overflow-hidden">
        <div className="shrink-0 px-3 pt-1.5 pb-1 border-b border-slate-100 flex items-center gap-1.5">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto exec-light-scroll px-3 py-2 space-y-2">
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50/60 px-2.5 py-2">
            ...
            <div className="mb-1.5">
              <p className="text-[9px] font-semibold tracking-wide text-slate-500 mb-0.5">Knows</p>
              <ul className="space-y-0 text-[11px] leading-tight text-slate-700">
            ...
            <div>
              <p className="text-[9px] font-semibold tracking-wide text-slate-500 mb-0.5">Can Answer</p>
              <ul className="space-y-0 text-[11px] leading-tight text-slate-700">
          ...
          <div className="rounded-lg border border-slate-200 bg-slate-50/60 px-2.5 py-2">
            ...
            <ol className="space-y-0 text-[11px] leading-tight text-slate-700">
        ...
        <div className="shrink-0 px-2.5 py-2 border-t border-slate-100">
          <button
            type="button"
      ...
      <div className="flex flex-col min-h-0 rounded-xl border border-purple-200 bg-white overflow-hidden">
        <div className="shrink-0 px-3 pt-1.5 pb-1 border-b border-purple-100 flex items-center gap-1.5">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto exec-light-scroll px-3 py-2 space-y-2">
          ...
          <div className="rounded-lg border border-purple-200 bg-purple-50/40 px-2.5 py-2">
            {/* Notification header */}
            <div className="flex items-center gap-1.5 mb-1">
              <Bell className="w-3.5 h-3.5 text-purple-600" />
              <span className="text-[10px] font-semibold tracking-wide text-purple-700">Advisor Notification</span>
            </div>
            <div className="text-[10px] leading-tight text-slate-600 space-y-0 mb-1.5">
            ...
            {/* Prep brief */}
            <div className="rounded-md border border-purple-200/60 bg-white px-2 py-1.5 mb-1.5">
              <div className="flex items-center gap-1.5 mb-0.5">
                <FileText className="w-3 h-3 text-purple-600" />
                <span className="text-[9px] font-semibold tracking-wide text-purple-700">Prep Brief Includes</span>
              </div>
              <ul className="space-y-0 text-[11px] leading-tight text-slate-700">
                <li className="flex gap-1.5"><span className="text-purple-400 mt-0.5">•</span> <span>Suggested talking points based on detected signal</span></li>
                <li className="flex gap-1.5"><span className="text-purple-400 mt-0.5">•</span> <span>Cross-sell opportunities aligned to behavior</span></li>
                <li className="flex gap-1.5"><span className="text-purple-400 mt-0.5">•</span> <span>Recent activity summary</span></li>
              </ul>
            </div>
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-1.5">
                    <div>
                      <p className="text-[9px] uppercase tracking-wider text-slate-400 mb-0.5">Automated</p>
                      <div className="grid grid-cols-2 gap-1.5">
                        <button className="text-left text-[10.5px] font-semibold rounded-md border border-slate-200 bg-white px-2 py-1 text-slate-700 hover:bg-slate-50 inline-flex items-center gap-1">
                          <Bell className="w-3 h-3 text-slate-500 shrink-0" /> <span className="truncate">Notify Wealth Advisor</span>
                        </button>
                        <button
                          type="button"
                          onClick={onOpenWMCopilot}
                          className="text-left text-[10.5px] font-semibold rounded-md border border-slate-200 bg-white px-2 py-1 text-slate-700 hover:bg-slate-50 inline-flex items-center gap-1"
                        >
                    ...
                    <div>
                      <p className="text-[9px] uppercase tracking-wider text-slate-400 mb-0.5">Advisor Actions</p>
                      <div className="grid grid-cols-2 gap-1.5">
                        <button className={`text-left text-[10.5px] font-semibold rounded-md border px-2 py-1 inline-flex items-center gap-1 ${consultStyle}`}>
        ...
        <div className="shrink-0 px-2.5 py-2 border-t border-purple-100">
          <button
            type="button"
            onClick={onOpenWMCopilot}
            className={`w-full inline-flex items-center justify-center gap-1.5 text-[11.5px] font-bold rounded-lg px-3 py-1.5 transition-all border-2 ${
