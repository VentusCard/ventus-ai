          ...
          {deals.map((deal) => (
            ...
            >
              <div className="flex-1 min-w-0">
                <p className={cn("font-bold text-slate-800", presentationMode ? "text-[12px] leading-tight" : "text-[13px] leading-snug")}>{deal.cardTitle ? deal.cardTitle : [deal.merchant, deal.product].filter(Boolean).join(" ")}</p>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto px-3 py-3 space-y-2.5" style={{ scrollbarWidth: "none" }}>
        ...
        <div className="rounded-xl px-3 py-2 flex items-center justify-between" style={{ background: "linear-gradient(135deg, #eff6ff, #eef2ff)" }}>
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[12px] font-semibold text-slate-700">Welcome, {firstName}!</span>
          </div>
          <div className="flex items-center gap-1">
            <TrendingUp className="w-3.5 h-3.5 text-emerald-500" />
            <span className="text-[11px] font-bold text-emerald-600">${yearlySavings} saved this year</span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-1.5">
            ...
            <div>
              <p className="text-[12px] font-bold text-slate-800">Welcome to New York</p>
              <p className="text-[10px] text-slate-500">Explore perks for TCBY Members</p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-1.5">
            <div className="flex rounded-lg border border-slate-100 bg-white overflow-hidden">
              ...
              <div className="px-2 py-1.5 flex-1 min-w-0">
                <p className="text-[9px] text-slate-500 truncate">MoMA</p>
            ...
            <div className="flex rounded-lg border border-slate-100 bg-white overflow-hidden">
              ...
              <div className="px-2 py-1.5 flex-1 min-w-0">
                <p className="text-[9px] text-slate-500 truncate">NY Mets</p>
        ...
        {!isSearchActive && topPick && (
          ...
          >
            <div className="flex items-center gap-1 mb-1.5">
              ...
              <span className="text-[10px] font-bold text-amber-600 uppercase tracking-wider">Top Pick For You</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex-1 min-w-0">
                <p className="text-[13px] font-bold text-slate-800 truncate">{topPick.deal.merchant}</p>
              </div>
        ...
        {!isSearchActive && expiringSoon.length > 0 && (
          <div>
            <div className="flex items-center gap-1.5 mb-1.5">
              ...
              <span className="text-[12px] font-bold text-slate-700">Expiring Soon</span>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mt-1">
                      {deal.rewardValue && (
                        <span className="text-[10px] font-semibold text-slate-600">{deal.rewardValue}</span>
                      )}
                      <span className={`text-[9px] font-bold ${isUrgent ? "text-red-500" : "text-amber-500"}`}>
