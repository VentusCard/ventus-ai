          ...
          <div>
            ...
            {synthesisTriggered && rollupStats.length > 0 && (
              <div className="mb-2.5">
                <p className="text-[13px] font-bold text-slate-800 mb-1.5">Behavioral Intelligence: <span className="text-slate-500 font-semibold">Personas = Multi-category Spending Patterns</span></p>
