      ...
      <main className="pt-32 md:pt-36">
        ...
        <section className="py-8 md:py-12 bg-white">
          <div className="max-w-5xl mx-auto px-6 md:px-8">
            <div className="text-center mb-8 animate-fade-in-down" style={{ animationDelay: '0ms', animationFillMode: 'backwards' }}>
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-3">
                Book a Meeting
              </h1>
              <p className="text-base md:text-lg text-gray-500">
                Select a time for our 30-minute discovery call.
              </p>
            </div>
        ...
        {/* Contact form */}
        <section className="py-8 md:py-12 bg-slate-50 border-t border-slate-200">
          <div className="max-w-2xl mx-auto px-6 md:px-8 text-center">
            ...
            <h2
              className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 animate-fade-in-down"
              style={{ animationDelay: '80ms', animationFillMode: 'backwards' }}
            >
              Let's talk.
            </h2>
            <p
              className="text-base md:text-lg text-gray-500 mb-8 animate-fade-in-down"
            ...
            <div
              className="relative rounded-2xl border border-gray-200 bg-white shadow-sm p-5 md:p-6 text-left animate-fade-in-down"
