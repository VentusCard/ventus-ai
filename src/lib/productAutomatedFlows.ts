...
export const PRODUCT_FLOWS: ProductFlow[] = [
  ...
  // ===== BUSINESS-OWNER INFERRED =====
  {
    ...
    signals: [
      { label: "Owner-operator cash flow", evidence: "Recurring card-processor settlement credits (e.g. 'SQ *DEPOSIT', 'STRIPE TRANSFER', 'TOAST POS') landing in a personal or hybrid DDA.", type: "behavioral" },
      { label: "Expansion spend cluster", evidence: "Clustered ACH to commercial contractors, equipment dealers, and permit/licensing authorities beyond normal operating spend.", type: "life-event" },
      { label: "No existing commercial debt service", evidence: "Absence of recurring commercial loan payments despite sustained business receipts and supplier ACH volume.", type: "behavioral" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Seasonal receipt volatility", evidence: "Processor settlement credits swinging materially quarter to quarter, with balances dipping ahead of payroll debits.", type: "behavioral" },
      { label: "Payables strain", evidence: "Supplier and wholesale ACH debits clearing late in the cycle, occasional overdraft or transfer-in to cover payroll provider debits.", type: "behavioral" },
      { label: "Merchant cash advance usage", evidence: "Daily or weekly fixed ACH debits to alternative-finance providers, a signature of high-cost MCA repayment.", type: "behavioral" },
    ],
    estimatedAudience: 4_200_000,
    penetration: 0.008,
  },
  {
    ...
    signals: [
      { label: "Recurring equipment rental", evidence: "Monthly ACH or card payments to equipment rental and leasing companies sustained over multiple quarters.", type: "behavioral" },
      { label: "Rising maintenance spend", evidence: "Increasing card spend at industrial repair, parts, and service vendors indicating aging owned equipment.", type: "behavioral" },
      { label: "Trade-supplier footprint", evidence: "Ongoing ACH to wholesale trade distributors and B2B suppliers consistent with an operating business.", type: "behavioral" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Business rent to landlord entity", evidence: "Recurring large ACH or bill-pay to an LLC or property management entity, separate from residential housing payments.", type: "behavioral" },
      { label: "Commercial utility & services", evidence: "Recurring commercial-rate utility, waste, and alarm/monitoring payments tied to a non-residential address.", type: "behavioral" },
      { label: "Stable multi-year receipts", evidence: "Consistent processor settlements and B2B inbound ACH over 24+ months supporting debt-service capacity.", type: "behavioral" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Processor settlements in personal DDA", evidence: "Card-processor settlement credits and marketplace payouts depositing directly into a consumer checking account.", type: "behavioral" },
      { label: "Quarterly estimated tax payments", evidence: "Recurring quarterly ACH debits to 'IRS USATAXPYMT' and state revenue departments, sized to self-employment income.", type: "behavioral" },
      { label: "New entity formation", evidence: "One-time payments to secretary of state filing services, registered agents, or business formation platforms.", type: "life-event" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Idle operating balance", evidence: "Sustained balances well above the trailing payroll and supplier outflow run rate, with no interest-bearing counterpart.", type: "behavioral" },
      { label: "Tax reserve accumulation", evidence: "Balance build-up between quarterly IRS estimated tax debits, drawn down at each filing date.", type: "behavioral" },
      { label: "External treasury shopping", evidence: "Outbound ACH to money-market or treasury platforms marketed to small businesses.", type: "behavioral" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Third-party processor fees", evidence: "Recurring monthly fee debits from external payment processors alongside their settlement credits.", type: "behavioral" },
      { label: "Hardware & POS spend", evidence: "Card purchases of terminals, readers, and POS subscription software from non-bank providers.", type: "behavioral" },
      { label: "Delayed funding pattern", evidence: "Settlement credits arriving on multi-day lag relative to observed sales cadence, indicating slower external funding.", type: "behavioral" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Multi-user supplier spend", evidence: "Business supplier and B2B SaaS charges appearing across several cards on the same household relationship.", type: "behavioral" },
      { label: "Consumer card carrying business volume", evidence: "Wholesale, freight, and advertising-platform charges concentrated on a personal credit card.", type: "behavioral" },
      { label: "Expense tooling subscriptions", evidence: "Recurring charges to expense-management or accounting platforms indicating spend-control need.", type: "behavioral" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "High-frequency fuel spend", evidence: "Fuel purchases materially above household norms, often multiple transactions per day across separate stations.", type: "behavioral" },
      { label: "Vehicle maintenance cadence", evidence: "Recurring card spend at commercial tire, fleet service, and truck repair vendors.", type: "behavioral" },
      { label: "Commercial vehicle obligations", evidence: "Recurring payments for commercial auto insurance, DOT/registration fees, or toll fleet accounts.", type: "behavioral" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Self-employment income, no employer plan", evidence: "Processor settlements and 1099-style inbound ACH with no employer payroll credit and no retirement plan deduction.", type: "behavioral" },
      { label: "Quarterly estimated tax burden", evidence: "Recurring IRS and state estimated tax debits indicating taxable income that a qualified plan could shelter.", type: "behavioral" },
      { label: "Ad-hoc retirement funding", evidence: "Irregular lump-sum transfers to external IRA providers, typically clustered near filing deadlines.", type: "behavioral" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Mature owner profile", evidence: "Long-tenured business receipts alongside retirement-age demographic markers and rising retained balances.", type: "behavioral" },
      { label: "Advisory engagement", evidence: "Bill-pay to M&A advisors, business brokers, valuation firms, or transaction attorneys.", type: "life-event" },
      { label: "Liquidity event preparation", evidence: "Escrow-related wires or attorney IOLTA transfers preceding a business sale.", type: "life-event" },
    ],
  ...
  },
  {
    ...
    signals: [
      { label: "Competitor payroll debits", evidence: "Recurring ACH debits to third-party payroll providers on a strict bi-weekly or semi-monthly cadence.", type: "behavioral" },
      { label: "First payroll run", evidence: "Initial payroll-provider setup fee followed by the first employee disbursement batch, indicating a newly hiring employer.", type: "life-event" },
      { label: "Employment tax deposits", evidence: "Recurring federal and state employment tax deposits ('EFTPS', state withholding) separate from personal tax activity.", type: "behavioral" },
    ],
    estimatedAudience: 3_600_000,
    penetration: 0.007,
  },
  {
    ...
    signals: [
      { label: "External commercial premiums", evidence: "Recurring premium payments to commercial P&C carriers or brokers rather than a bank-affiliated program.", type: "behavioral" },
      { label: "Uninsured commercial footprint", evidence: "Commercial lease, utility, and supplier activity with no observable commercial insurance premium.", type: "behavioral" },
      { label: "Business asset build-out", evidence: "Large equipment and fixture purchases increasing insurable value at the business location.", type: "life-event" },
    ],
    estimatedAudience: 4_800_000,
    penetration: 0.010,
  },
  {
    ...
    signals: [
      { label: "Payroll present, no comp premium", evidence: "Consistent payroll-provider debits and employment tax deposits with no matching workers' comp carrier payment.", type: "behavioral" },
      { label: "Headcount growth", evidence: "Rising payroll debit amounts and batch sizes over consecutive cycles, indicating added employees.", type: "life-event" },
      { label: "Higher-hazard trade spend", evidence: "Supplier and tooling spend concentrated in construction, trades, or food service categories with elevated comp exposure.", type: "behavioral" },
    ],
    estimatedAudience: 2_800_000,
    penetration: 0.006,
  },
  {
    ...
    signals: [
      { label: "Owner-dependent revenue", evidence: "Business receipts concentrated in a single operating relationship with minimal payroll depth behind the owner.", type: "behavioral" },
      { label: "Commercial debt obligations", evidence: "Active commercial loan or lease payments that would survive the loss of the principal.", type: "behavioral" },
      { label: "Partnership structure", evidence: "Recurring inter-partner distributions or buy-sell agreement legal fees indicating multiple principals.", type: "behavioral" },
    ],
    estimatedAudience: 2_200_000,
    penetration: 0.004,
  },
