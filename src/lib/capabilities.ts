...
export const CAPABILITIES: readonly CapabilityDefinition[] = [
  ...
  },
  {
    ...
    internalReality: "Rules and authored scenarios are working; model-assisted strategy generation is not approved for runtime use.",
    status: "pilot-scope",
    leadershipVisible: true,
  ...
  },
  {
    ...
    internalReality: "Measurement contracts are defined; experiment assignment and outcome ingestion are not implemented.",
    status: "prototype",
    leadershipVisible: true,
  ...
  },
  {
    ...
    internalReality: "Benchmark harness exists; runtime OpenRouter use is explicitly disabled for the product demo.",
    status: "evaluation-locked",
    leadershipVisible: false,
