...
export const SIGNAL_FAMILY_META: {
  ...
  // Order matches the Systems tab: Behavioral → Life Event → Financial → Demographic → Risk.
  {
    ...
    cardBorderHover: "group-hover:border-blue-300",
    sparkline: "#2563eb",
    barStrong: "bg-blue-700",
    barLikely: "bg-blue-400",
    barEmerging: "bg-blue-200",
    rowHover: "hover:bg-blue-50/50",
    rowHoverBorder: "hover:border-blue-300",
    openText: "group-hover:text-blue-700",
  },
  {
    key: "life_event",
    label: "Life Events",
